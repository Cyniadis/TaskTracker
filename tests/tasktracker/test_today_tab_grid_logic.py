...
TODAY_ROW = {"id": '0', "completed": "☐"}
DONE_ROW = {"id": '0', "completed": "🗹"}
...
class TestOnRowSelected:
    def test_unchecked_row_marks_the_task_complete(self, make_task, today_tab_logic_app):
        task = make_task(name="Task A", priority=5.0, initial_priority=2.0, done_date=None)
    ...
    def test_checked_row_marks_the_task_uncomplete(self, today_tab_logic_app):
        task = Task(name="Task A", priority=2.0, initial_priority=2.0)
    ...
    def test_toggling_twice_returns_to_the_original_state(self, make_task, today_tab_logic_app):
        task = make_task(name="Task A", priority=3.0, initial_priority=1.0, done_date=None)
        today_tab_logic_app.session_state["tasks"] = [task]
        today_tab_logic_app.session_state["today_tasks"] = [task]
        today_tab_logic_app.session_state["today_generated"] = True
